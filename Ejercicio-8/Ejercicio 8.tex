...
Se propuso como primer diseño el presentado en la Figura (\ref{circuit:dis}). Este consta de un generador de clock que varía entre $100Hz$ y $2KHz$, el cual es provisto a un contador BCD que se reinicia al llegar al numero 99. Este contador posee sus salidas conectadas permanentemente a un módulo de display, el cual tiene una entrada de acquire, la cual, al pasar a estar en un estado alto el display, muestra y guarda el último número ingresado, aun así este pin pase a un estado bajo.
